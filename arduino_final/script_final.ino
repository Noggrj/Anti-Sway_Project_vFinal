...
void controlador ( float y ){
  
  const float b1 = 0.331;
  const float b2 = 0.9663;
  const float k = -12.073;
  float e = - y ;
 // p = k * e -(b1 + b2)* k *e1 + k*b1*b2*e2  + 2 *p1 -p2;
   // p = -1.32 * e;
    p = -3.0672*e+2.9876*e1+1.0005*p1;
